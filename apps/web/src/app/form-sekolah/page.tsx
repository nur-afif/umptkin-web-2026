              ...
              <div className="space-y-4">
                ...
                <div className="pt-4 border-t border-gray-200">
                  <div className="flex items-center gap-2 pb-2">
                    ...
                    <h4 className="font-semibold text-gray-800">Nomor Dokumen Pendukung <span className="text-red-500">*</span></h4>
                  </div>

                  <p className="text-xs text-gray-500 mb-4">
                    Salah satu nomor dokumen di bawah ini harus diisi untuk validasi akhir identitas peserta.
                  </p>

                  <div className="space-y-3">
                    <div className="space-y-2">
                      <label className="text-sm font-semibold text-gray-700">No. Ijazah</label>
                      <div className="relative">
                        <input
                          type="text"
                          maxLength={50}
                          value={formData.pendidikan.noIjazah}
                          onChange={(e) => setFormData({ ...formData, pendidikan: { ...formData.pendidikan, noIjazah: e.target.value } })}
                          className="w-full rounded-xl border-2 border-gray-200 bg-white px-4 py-3 pl-10 text-sm text-gray-700 focus:border-primary focus:outline-none transition-colors"
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-semibold text-gray-700">No. SKL (Surat Keterangan Lulus)</label>
                      <div className="relative">
                        <input
                          type="text"
                          maxLength={50}
                          value={formData.pendidikan.noSKL}
                          onChange={(e) => setFormData({ ...formData, pendidikan: { ...formData.pendidikan, noSKL: e.target.value } })}
                          className="w-full rounded-xl border-2 border-gray-200 bg-white px-4 py-3 pl-10 text-sm text-gray-700 focus:border-primary focus:outline-none transition-colors"
                          placeholder="Masukkan nomor SKL"
                        />
                        <FileText className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-400" />
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-semibold text-gray-700">No. KTP</label>
                      <div className="relative">
                        <input
                          type="text"
                          maxLength={16}
                          value={formData.pendidikan.noKTP}
                          onChange={(e) => setFormData({ ...formData, pendidikan: { ...formData.pendidikan, noKTP: e.target.value } })}
                          className="w-full rounded-xl border-2 border-gray-200 bg-white px-4 py-3 pl-10 text-sm text-gray-700 focus:border-primary focus:outline-none transition-colors"
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-semibold text-gray-700">No. Kartu Siswa</label>
                      <div className="relative">
                        <input
                          type="text"
                          maxLength={20}
                          value={formData.pendidikan.noKartuSiswa}
                          onChange={(e) => setFormData({ ...formData, pendidikan: { ...formData.pendidikan, noKartuSiswa: e.target.value } })}
                          className="w-full rounded-xl border-2 border-gray-200 bg-white px-4 py-3 pl-10 text-sm text-gray-700 focus:border-primary focus:outline-none transition-colors"
                          placeholder="Masukkan nomor kartu siswa"
                        />
                        <FileText className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-400" />
                      </div>
                    </div>
